...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('GTX4090', 'Santa', '1599', FALSE),
('Macair charger', 'Nick', '40', FALSE),
('Computer Mouse', 'Rudolf', '10', TRUE),
('Pepsi 2L', 'Elf on the Shelf', '2', TRUE),
('5 mangos', 'The Boss', '5', FALSE)
;
...
-- 
ALTER TABLE gifts ADD COLUMN ID SERIAL PRIMARY KEY;
...
--
DELETE FROM gifts WHERE giver LIKE 'Santa' RETURNING *;
