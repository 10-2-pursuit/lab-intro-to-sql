...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT NOT NULL, giver TEXT, value INT, previously_regifted BOOLEAN);
...
-- 
--starting name is already value, removed and added to get practice in
ALTER TABLE gifts DROP COLUMN value;
--\d gifts;
ALTER TABLE gifts ADD COLUMN value INT;
--\d gifts
-- 
\echo Insert a peach candle, given by 'Santa' thats value is 9 and has been previously regifted
-- 
INSERT INTO gifts (gift, giver, previously_regifted, value) VALUES ('peach candle', 'Santa', TRUE, 9);
--SELECT * FROM gifts;
--
...
('peach candle', 'Santa', '9', TRUE),
('tie', 'John', '20', TRUE),
('mouse', 'Aisha', '10', FALSE),
('keyboard', 'An Elf', '38', TRUE),
('guitar', 'Santa', '250', TRUE)
;
