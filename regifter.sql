...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('apple candle', 'Mrs. Claus', '15', FALSE),
('watermelon', 'Dan', '10', FALSE),
('cotton candy', 'Dancer', '35', TRUE),
('hookah', 'Richard', '45', TRUE),
('candy cane', 'Prancer', '27', FALSE);
